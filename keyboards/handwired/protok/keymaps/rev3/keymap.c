...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_gen2(
           ...
           KC_MUTE, _______,          _______, _______, KC_UP  , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
           KC_VOLU, _______,          _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    LAYOUT_gen2(
           ...
           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, LAG_NRM         , LAG_SWP, XXXXXXX, XXXXXXX, XXXXXXX, RAG_SWP, RAG_NRM, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                                                                                                                XXXXXXX, XXXXXXX, XXXXXXX),
